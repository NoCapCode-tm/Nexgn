...
export const ClipboardIcon = ({ color, size = 24 }) => (
...
export const FileIcon = ({ color, size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ContactIcon = ({ color, size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const HelpIcon = ({ color, size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
...
/** Returns true if a nav item should be highlighted as active */
