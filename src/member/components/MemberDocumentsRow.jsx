...
export default function MemberDocumentsRow({ title, note, signers, signedAt, owner, status, onRevoke }) {
  ...
  return (
    <div className="member-doc-row">
      ...
      <div className="member-doc-row__menu" ref={menuRef}>
        <button className="member-doc-row__menu-trigger" onClick={() => setMenuOpen(prev => !prev)}>
