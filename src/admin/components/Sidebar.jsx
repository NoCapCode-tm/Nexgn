...
function SunIcon({ color = "#8A949F" }) {
  return (
    ...
    >
      ...
      <path
        d="M12.5 2v2.5M12.5 20.5V23M23 12.5h-2.5M4.5 12.5H2M19.6 5.4l-1.77 1.77M7.17 17.83l-1.77 1.77M19.6 19.6l-1.77-1.77M7.17 7.17L5.4 5.4"
        stroke={color}
        strokeWidth="1.6"
        strokeLinecap="round"
      />
...
function MoonIcon({ color = "#8A949F" }) {
  return (
    ...
    >
      <path
        d="M20.5 15.7A9 9 0 1 1 9.3 4.5a7 7 0 0 0 11.2 11.2Z"
        stroke={color}
        strokeWidth="1.6"
...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`sidebar ${effectiveExpanded ? "sidebar--expanded" : ""}`}
    >
      ...
      <div className="sidebar__inner">
        ...
        <div className="sidebar__bottom">
          <button
            ...
            onClick={toggleDark}
            title={
              !expanded ? (isDark ? "Dark Mode" : "Light Mode") : undefined
            }
          >
            <span className="sidebar__icon-wrap">
              {isDark ? (
                <MoonIcon color="#FF0915" />
              ) : (
                <SunIcon color="#FF0915" />
              )}
            </span>
            {effectiveExpanded && (
