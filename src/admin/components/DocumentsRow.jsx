...
export default function DocumentsRow({ title, note, signers, signedAt, owner, status, onRevoke }) {
  ...
  return (
    <div className="admin-doc-row">
      ...
      <div className="admin-doc-row__title" data-label="TITLE">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="admin-doc-row__icon">
      ...
      <div className="admin-doc-row__note" data-label="NOTE">{note}</div>
      ...
      <div className="admin-doc-row__menu" ref={menuRef}>
        <button className="admin-doc-row__menu-trigger" onClick={() => setMenuOpen(prev => !prev)}>
